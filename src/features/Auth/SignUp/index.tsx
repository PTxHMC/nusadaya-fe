...
const SignUpPage = () => {
  return (
    <div className="flex min-h-screen justify-center bg-white-2 lg:justify-between">
      <div className="hidden w-1/2 flex-col items-center justify-center bg-primary-1 p-8 pr-0 text-white-1 lg:flex">
      ...
      <div className="w-full p-4 lg:w-1/2 lg:p-8 lg:pl-0">
        <div className="flex size-full flex-col items-center justify-center rounded-lg rounded-l-none bg-white-2 px-16 shadow-lg">
          ...
          <h1 className="mb-4 text-4xl font-extrabold">Nusadaya</h1>
          <AuthTab />
        </div>
      </div>
    </div>
