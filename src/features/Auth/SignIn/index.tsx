...
const SignInPage = () => {
  return (
    <div className="flex min-h-screen justify-center bg-white-2 lg:justify-between">
      <div className="w-full p-4 lg:w-1/2 lg:p-16 lg:pr-0">
      ...
      <div className="hidden w-1/2 flex-col items-center justify-center bg-primary-1 p-16 pl-0 text-white-1 lg:flex">
